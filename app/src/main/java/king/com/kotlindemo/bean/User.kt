...
*/
data class User(val _id: String, val createdAt: String, val desc: String, val images: String?, val publishedAt: String, val source: String, val type: String, val url: String, val used: String, val who: String)